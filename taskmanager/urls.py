...
urlpatterns = [
    ...
    path('admin-panel/users/create/', create_user, name='create_user'),
    path('admin-panel/users/<int:pk>/edit-role/', edit_user_role, name='edit_user'),
    path('admin-panel/users/<int:pk>/delete/', delete_user, name='delete_user'),
    path('admin-panel/admins/', admin_list, name='admin_list'),
    path('admin-panel/tasks/', task_list, name='task_list'),
    path('admin-panel/tasks/create/', create_task, name='create_task'),
    path('admin-panel/tasks/<int:pk>/', task_detail, name='task_detail'),
    path('admin-panel/tasks/<int:pk>/update/', update_task, name='update_task'),
]